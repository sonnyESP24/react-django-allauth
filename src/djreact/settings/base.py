...
TEMPLATES = [
    {
        ...
        # insert your TEMPLATE_DIRS here
            ...
            os.path.join(BASE_DIR, 'djreact/templates/react'),
            #os.path.join(BASE_DIR, '/home/m/code_source/5reactdjango/boilerplate-redjang/src/django/djreact/templates/react'),
        ],
